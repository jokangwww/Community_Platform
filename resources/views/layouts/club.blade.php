...
<head>
    ...
    <title>@yield('title', 'Club Dashboard')</title>
...
<body>
    <header class="topbar">
        ...
        <div class="user-area">
            <span class="welcome-text">@yield('welcome_text', 'Welcome, ' . (auth()->user()->name ?? 'Club User'))</span>
    ...
    <div class="layout">
        <aside class="sidebar">
            ...
            <ul class="nav-list is-collapsed" id="event-nav">
                <li><a class="nav-link {{ request()->routeIs('club.event-posting*') ? 'is-active' : '' }}" href="{{ route('club.event-posting') }}">Event Posting</a></li>
                <li><a class="nav-link {{ request()->routeIs('club.recruitment*') ? 'is-active' : '' }}" href="{{ route('club.recruitment') }}">Recruitment</a></li>
                <li><a class="nav-link {{ request()->routeIs('club.events.*') ? 'is-active' : '' }}" href="{{ route('club.events.index') }}">Event</a></li>
                <li><a class="nav-link {{ request()->routeIs('club.feedback.*') ? 'is-active' : '' }}" href="{{ route('club.feedback.index') }}">Feedback</a></li>
                <li><a class="nav-link {{ request()->routeIs('club.tickets.*') ? 'is-active' : '' }}" href="{{ route('club.tickets.index') }}">E-Ticket</a></li>
    ...
    <script>
        function initSidebarToggle() {
            ...
            const stored = localStorage.getItem('clubEventNavExpanded');
            ...
            sidebarToggle.onclick = () => {
                ...
                localStorage.setItem('clubEventNavExpanded', String(nextExpanded));
            };
        }
