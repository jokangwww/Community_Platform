...
@section('content')
    ...
    <div class="va-switch">
        <a href="{{ route('club.vendor-booth-applications.index') }}">Booth Setup</a>
        <a href="{{ route('club.vendor-booth-applications.applications') }}" class="is-active">Vendor Applications</a>
    </div>

    <section class="va-p">
        <form method="GET" action="{{ route('club.vendor-booth-applications.applications') }}" class="va-f">
            ...
            <a href="{{ route('club.vendor-booth-applications.applications') }}">Reset</a>
        </form>
